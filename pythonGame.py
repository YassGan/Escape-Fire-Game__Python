...
bg = pygame.image.load('./assets/1bg2.jpg').convert()
hh = 75
ss = pygame.image.load('./assets/ss.png')

firewoosh = pygame.mixer.Sound(
    "./assets/firewoosh1.wav")
...
class Player(object):
    walkRight = [pygame.image.load('./assets/R1.png'), pygame.image.load('./assets/R2.png'), pygame.image.load('./assets/R3.png'), pygame.image.load('./assets/R4.png'), pygame.image.load(
        './assets/R5.png'), pygame.image.load('./assets/R6.png')]
    walkLeft = [pygame.image.load('./assets/L1.png'), pygame.image.load('./assets/L2.png'), pygame.image.load('./assets/L3.png'), pygame.image.load('./assets/L4.png'), pygame.image.load(
        './assets/L5.png'), pygame.image.load('./assets/L6.png')]
...
class flamme():
    def __init__(self, x, y):
        ...
        self.flamme = pygame.image.load('./assets/s1.png')
        self.flammemoving = [pygame.image.load('./assets/Fire moving/1.png'), pygame.image.load('./assets/Fire moving/2.png'), pygame.image.load('./assets/Fire moving/3.png'), pygame.image.load('./assets/Fire moving/4.png'), pygame.image.load('./assets/Fire moving/5.png'), pygame.image.load('./assets/Fire moving/6.png'), pygame.image.load('./assets/Fire moving/7.png'), pygame.image.load(
            './assets/Fire moving/8.png'), pygame.image.load('./assets/Fire moving/9.png'), pygame.image.load('./assets/Fire moving/10.png')]
        self.flammeb = pygame.image.load('./assets/blue.png')
...
class enemy():
    global secondpath
    wwalkRight = [pygame.image.load('./assets/R1E.png'), pygame.image.load('./assets/R2E.png'), pygame.image.load('./assets/R3E.png'), pygame.image.load('./assets/R4E.png'), pygame.image.load('./assets/R5E.png'), pygame.image.load(
        './assets/R6E.png'), pygame.image.load('./assets/R7E.png')]
    wwalkLeft = [pygame.image.load('./assets/L1E.png'), pygame.image.load('./assets/L2E.png'), pygame.image.load('./assets/L3E.png'), pygame.image.load('./assets/L4E.png'), pygame.image.load('./assets/L5E.png'), pygame.image.load(
        './assets/L6E.png'), pygame.image.load('./assets/L7E.png')]
